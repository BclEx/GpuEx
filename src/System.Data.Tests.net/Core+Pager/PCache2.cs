...
// pcache2.test
using Xunit;
public class PCache2 : TesterBase
{
    // Set up a pcache memory pool so that we can easily track how many pages are being used for cache.
    [Fact]
    public void T1()
    {
        do_test("pcache2-1.1", () =>
        ...
        // Make lots of changes on the first connection.  Verify that the page cache usage does not grow to consume the page space set aside
