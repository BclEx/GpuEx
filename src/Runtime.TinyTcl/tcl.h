...
EXTERN void		Tcl_AppendElement(Tcl_Interp *interp, const char *string, int noSep);
EXTERN void		Tcl_AppendResult(Tcl_Interp *interp, ...) ATTRIBUTE_SENTINEL;
...
EXTERN int		Tcl_CreatePipeline(Tcl_Interp *interp, int argc, char **argv, int **pidArrayPtr, int *inPipePtr, int *outPipePtr, int *errFilePtr);
...
EXTERN char *	Tcl_ErrnoId();
EXTERN int		Tcl_Eval(Tcl_Interp *interp, char *cmd, int flags, char **termPtr);
EXTERN int		Tcl_EvalFile(Tcl_Interp *interp, char *fileName);
EXTERN int		Tcl_ExprBoolean(Tcl_Interp *interp, char *string, int *ptr);
EXTERN int		Tcl_ExprDouble(Tcl_Interp *interp, char *string, double *ptr);
EXTERN int		Tcl_ExprLong(Tcl_Interp *interp, char *string, long *ptr);
EXTERN int		Tcl_ExprString(Tcl_Interp *interp, char *string);
EXTERN int		Tcl_Fork();
EXTERN int		Tcl_GetBoolean(Tcl_Interp *interp, char *string, int *boolPtr);
EXTERN int		Tcl_GetDouble(Tcl_Interp *interp, char *string, double *doublePtr);
EXTERN int		Tcl_GetInt(Tcl_Interp *interp, char *string, int *intPtr);
...
EXTERN void		Tcl_InitUnix(Tcl_Interp *interp);
EXTERN char *	Tcl_Merge(int argc, char **argv);
EXTERN char *	Tcl_ParseVar(Tcl_Interp *interp, char *string, char **termPtr);
...
EXTERN void		Tcl_SetErrorCode(Tcl_Interp *interp, ...) ATTRIBUTE_SENTINEL;
EXTERN void		Tcl_SetResult(Tcl_Interp *interp, char *string, Tcl_FreeProc *freeProc);
...
EXTERN int		Tcl_SplitList(Tcl_Interp *interp, char *list, int *argcPtr, char ***argvPtr);
EXTERN int		Tcl_StringMatch(char *string, char *pattern);
EXTERN char *	Tcl_TildeSubst(Tcl_Interp *interp, char *name);
...
EXTERN int		Tcl_VarEval(Tcl_Interp *interp, ...) ATTRIBUTE_SENTINEL;
...
EXTERN int		Tcl_WaitPids(int numPids, int *pidPtr, int *statusPtr);
