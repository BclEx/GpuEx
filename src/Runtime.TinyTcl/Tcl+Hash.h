...
typedef struct Tcl_HashEntry {
	struct Tcl_HashEntry *nextPtr;	// Pointer to next entry in this hash bucket, or NULL for end of chain.
...
typedef struct Tcl_HashTable {
	...
	int numBuckets;			// Total number of buckets allocated at **bucketPtr.
...
typedef struct Tcl_HashSearch {
	...
	Tcl_HashEntry *nextEntryPtr;	// Next entry to be enumerated in the the current bucket.
} Tcl_HashSearch;
