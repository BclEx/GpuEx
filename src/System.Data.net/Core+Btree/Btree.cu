...
#pragma region Open / Close
	...
	__device__ static int BtreeInvokeBusyHandler(void *arg)
	{
		...
		_assert(_mutex_held(bt->Ctx->Mutex));
...
#pragma region Integrity Check
	...
	__device__ static void CheckAppendMsg_(IntegrityCk *check, char *msg1, const char *fmt, _va_list &args)
	{
		//_va_list ap;
...
#if __CUDACC__
	__device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt) { _va_list args; _va_start(args); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
	template <typename T1> __device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt, T1 arg1) { va_list1<T1> args; _va_start(args, arg1); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
	template <typename T1, typename T2> __device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt, T1 arg1, T2 arg2) { va_list2<T1,T2> args; _va_start(args, arg1, arg2); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
	template <typename T1, typename T2, typename T3> __device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt, T1 arg1, T2 arg2, T3 arg3) { va_list3<T1,T2,T3> args; _va_start(args, arg1, arg2, arg3); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
	template <typename T1, typename T2, typename T3, typename T4> __device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt, T1 arg1, T2 arg2, T3 arg3, T4 arg4) { va_list4<T1,T2,T3,T4> args; _va_start(args, arg1, arg2, arg3, arg4); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
	template <typename T1, typename T2, typename T3, typename T4, typename T5> __device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) { va_list5<T1,T2,T3,T4,T5> args; _va_start(args, arg1, arg2, arg3, arg4, arg5); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
#else
	__device__ inline static void CheckAppendMsg(IntegrityCk *check, char *msg1, const char *fmt, ...) { _va_list args; _va_start(args, fmt); CheckAppendMsg_(check, msg1, fmt, args); _va_end(args); }
#endif
