...
#define IfNullFunc VersionFunc // Substitute function - never called
	...
	__constant__ static _WSD FuncDef g_builtinFuncs[] =
	{
		...
		LIKEFUNC(glob, 2, &_globInfo, (FUNC)((int)FUNC_LIKE|(int)FUNC_CASE)),
#ifdef CASE_SENSITIVE_LIKE
		LIKEFUNC(like, 2, &_likeInfoAlt, (FUNC)((int)FUNC_LIKE|(int)FUNC_CASE)),
		LIKEFUNC(like, 3, &_likeInfoAlt, (FUNC)((int)FUNC_LIKE|(int)FUNC_CASE)),
#else
